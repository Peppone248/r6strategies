...
public class CostaStrat2 extends AppCompatActivity {
    ...
    private void setPagerAdapter(){
        myFragmentPagerAdapter2 = new com.example.r6strategies.coastline.MyFragmentPagerAdapter2(getSupportFragmentManager());
